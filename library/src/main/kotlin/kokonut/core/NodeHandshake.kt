...
/**
 * Handshake request from Light Node to Full Node This initiates the connection ritual between nodes
 */
@Serializable
...
/**
 * Handshake response from Full Node to Light Node Contains essential network information for the
 * Light Node to verify
 */
@Serializable
