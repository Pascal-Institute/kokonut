...
class HandshakeIntegrationTest {
    ...
    fun `test handshake accepts valid public key`() {
        ...
        val request = HandshakeRequest(nodeType = "LIGHT", publicKey = validPublicKey)
    ...
    */
    ...
    fun `test multiple handshake requests with same key`() {
        ...
        val request1 = HandshakeRequest(nodeType = "LIGHT", publicKey = publicKey)

        val request2 = HandshakeRequest(nodeType = "LIGHT", publicKey = publicKey)
    ...
    */
    ...
    fun `test handshake error messages are descriptive`() {
        ...
        errorMessages.forEach { message ->
            ...
            assertTrue(
                    message.contains(":") || message.contains("failed"),
